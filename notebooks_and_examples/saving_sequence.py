...
width, height, frames_per_second, sequence = load_sequence(
    '../../simple-object-tracking/sample_data/ball-8.mp4'
)
...
save_sequence(sequence, width, height, frames_per_second, '../../output.mp4')
